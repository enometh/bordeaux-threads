...
;; handle depth-1 relative links to parent directories
(defvar $scanner3 (cl-ppcre:create-scanner "href=\"\\.\\./([a-z]+)\""))

(defun replacer3 (target-string start end match-start match-end reg-starts reg-ends)
  (declare (ignorable target-string start end  match-start match-end reg-starts reg-ends))
  (concatenate 'string "href=\"../" (subseq target-string (elt reg-starts 0) (elt reg-ends 0)) "/index.html\""))

#+nil
(equal (cl-ppcre:regex-replace $scanner3
			       "<a href=\"../semaphore\"><strong>semaphore</strong></a>"
			       #'replacer3)
 "<a href=\"../semaphore/index.html\"><strong>semaphore</strong></a>")
...
(defun doreplace-string (string *level*)
  (let* ((pass1 (cl-ppcre:regex-replace-all $scanner0 string #'replacer0))
	 ...
	 (pass4 (cl-ppcre:regex-replace-all $scanner3 pass3 #'replacer3)))
    pass4))
...
;;;
;;;
(defvar $lw-man-url "http://www.lispworks.com/documentation/HyperSpec/Body")
(defvar $lw-man-rep-url "file:///opt/lw801/lib/8-0-0-0/manual/html-l/CLHS/Body")
(defvar $lw-man-rep-scanner (cl-ppcre:create-scanner $lw-man-url))
(defun lw-man-replacer (string *level*)
  (cl-ppcre:regex-replace-all $lw-man-rep-scanner string $lw-man-rep-url))


#||
(setq $s "<em>generalized-boolean</em> -&gt; a <a href=\"http://www.lispworks.com/documentation/HyperSpec/Body/26_glo_g.htm#generalized_boolean\">generalized")
(lw-man-replacer $s)
||#

#+nil
(doreplace-files (make-file-list)
		 :function #'lw-man-replacer)
